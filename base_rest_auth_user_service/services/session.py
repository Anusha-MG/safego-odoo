...
class PartnerNewApiService(Component):
    ...
    # 1.API to get the details of customer with id and other details
    ...
    # 2.API to get the details of all agent names
    @restapi.method([(["/agent_names"], "GET")], auth="public")
    def agent_names(self):
        agent_dict = list()
        agent_name = self.env['res.partner'].search(['|',('is_newsprint_agent', '=', True), ('is_clearing_agent', '=', True)])

        for agent in agent_name:
            address = str(agent.street if agent.street else ' ') + ' ' + str(
                agent.street2 if agent.street2 else ' ') + ' ' + str(
                agent.city if agent.city else ' ') + ' ' + str(
                agent.country_id.name if agent.country_id.name else ' ')
            agent_dict.append({
                'id': agent.id,
                'name': agent.name,
                'address': address,
                'gst': agent.vat,
                'pan': agent.l10n_in_pan,
                'phone': agent.phone,
                'mobile': agent.mobile,
                'email': agent.email,
    ...
    # 3.API to get the list of pricelist
    ...
    # 4.API to get the list of quotation templates with id and other details
    ...
    # 5.API to get the list of products with id and other details
    ...
    # 6.API to get list of payments terms with id and other details
    ...
    # 7.API to get list of unit of measure with id and other details
    ...
    # 8.API to get list of account deposit with id and other details
    ...
    # 9.API to get list of advertisement position with id and other details
    ...
    # 10.API to get list of sale document with id and other details
    ...
    # 11.API to get list of reta target scheme with id and other details
    ...
    # 12.API to get list of reta agents target with id and other details
    ...
    # 13.API to get list of taxes with id and other details
    ...
    # 14.API to post the quotation details with details
    ...
    # 15.API to post the create customer with details
    ...
    def create_customer(self):
        ...
        gst_treatment = self.env['res.partner'].search(
            [('vat', '=', params.get('vat'))])
    ...
    # 16.API to get the sale order history with id and other details
    ...
    # 17.API to update the exisiting customer details
    ...
    # 18.API to post the job applications
    ...
    # 19.API to get the job applications with id and other details
